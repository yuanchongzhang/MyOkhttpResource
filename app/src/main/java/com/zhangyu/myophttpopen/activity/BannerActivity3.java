...
public class BannerActivity3 extends BaseDetailActivity {
        ...
        OkGo.get("http://121.42.26.208:83/interface/json_index.php?areaid=1&page=1&uid=")//
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        Toast.makeText(BannerActivity3.this, "请求成功", Toast.LENGTH_SHORT).show();
                        ...
                        banner2.setOnBannerItemClickListener(new BannerLayout.OnBannerItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                Toast.makeText(BannerActivity3.this, String.valueOf(position), Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void initListener(final int currIndex) {
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(BannerActivity3.this, mDatas.get(pos).appName + "---" + pos, Toast.LENGTH_SHORT).show();
            }
        });
    }
