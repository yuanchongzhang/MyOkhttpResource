...
import com.zhangyu.myophttpopen.section.BaseHeaderAdapter;
import com.zhangyu.myophttpopen.section.PinnedHeaderEntity;

import java.util.ArrayList;
import java.util.List;

public class MySectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    case BaseHeaderAdapter.TYPE_DATA:
                        ...
                        if (mRecyclerView.getLayoutManager() instanceof StaggeredGridLayoutManager) {
                            ...
                            if (mRandomHeights.get(position) == 0) {
                                mRandomHeights.put(position, dip2px(MySectionActivity.this, (int) (100 + Math.random() * 100)));
                            }
                        ...
                        Glide.with(MySectionActivity.this).load(item.getData()).into((ImageView) holder.getView(R.id.iv_animal));
                        break;
                }
            }
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                switch (mAdapter.getItemViewType(position)) {
                    case BaseHeaderAdapter.TYPE_DATA:
                        ...
                        Toast.makeText(MySectionActivity.this, entity.getPinnedHeaderName() + ", position " + position + ", id " + entity.getData(), Toast.LENGTH_SHORT).show();
                        break;
                    case BaseHeaderAdapter.TYPE_HEADER:
                        entity = mAdapter.getData().get(position);
                        Toast.makeText(MySectionActivity.this, "click, tag: " + entity.getPinnedHeaderName(), Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        ...
        OnHeaderClickListener headerClickListener = new OnHeaderClickListener() {
            ...
            public void onHeaderClick(View view, int id, int position) {
                Toast.makeText(MySectionActivity.this, "click, tag: " + mAdapter.getData().get(position).getPinnedHeaderName(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onHeaderLongClick(View view, int id, int position) {
                Toast.makeText(MySectionActivity.this, "long click, tag: " + mAdapter.getData().get(position).getPinnedHeaderName(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onHeaderDoubleClick(View view, int id, int position) {
                Toast.makeText(MySectionActivity.this, "double click, tag: " + mAdapter.getData().get(position).getPinnedHeaderName(), Toast.LENGTH_SHORT).show();
            }
        };
